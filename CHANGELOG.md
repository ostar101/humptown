...
### Added (D-091, D-092, D-093, D-094, D-095, D-096)
...
### Fixed
- People no longer greet you with their job's line wherever they stand (Veikko in the bar talking about ropes): job greetings are said at work, with different ones off duty (D-075).
...
### Added
- Going to sleep, working a shift, walking to another district, collapsing and a night in the cells now play a short scene: the screen dims, a line says what is happening while the clock runs from start to finish, and the new time is uncovered. Any key skips it (D-076).
